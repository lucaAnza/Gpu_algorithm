...
\begin{figure}[h]
    \includegraphics[width=1\linewidth]{basic_kernel.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{cuda_thread.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{cuda_block.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{cuda_grid.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{type_of_memory.png}
