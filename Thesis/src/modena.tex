...
\begin{table}[H]
    \centering
    \caption{Risultati temporali (\textbf{KITTY DATASET - 04}) [laptop] }
    \begin{tabular}{lcccccc}
        \toprule
        \rowcolor{gray!20}
        Radius multiplier & 1.0 & \cellcolor{orange!40}2.0 & 4.0 & 8.0 & 16.0 \\
        %%%
        Stereo Matching \textcolor{blue}{GPU} (ms) & 3.00 & 3.00 & 3.00 & 3.00 & 3.00 \\
        %%%
        %%%
        Stereo Matching \textcolor{blue}{GPU} (ms) & 3.00 & 3.00 & 3.00 & 3.00 & 3.00 \\
        %%%
        ...
        Stereo Matching \textcolor{blue}{GPU} (ms) & 3.00 & 3.00 & 3.00 & 3.00 & 3.00 \\
        %%%
        Stereo Matching \textcolor{orange}{CPU} (ms) & 3.00 & 3.00 & 3.00 & 3.00 & 3.00\\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    \centering
    \caption{Risultati globali con raggio pari al valore di default 2 \newline(\textbf{KITTY DATASET - 06}) [laptop]}
    \begin{tabular}{lcccccc}
        \toprule
        \rowcolor{gray!20}
        Device & \cellcolor{blue!20}GPU & \cellcolor{orange!20}CPU  \\
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\textwidth]{img/time_comparison_laptop_kitti06.png}}
    \caption{Comparazione dei tempi sull'algoritmo di Stereo Matching }
\end{figure}
...
\begin{table}[H]
    \centering
    \caption{Risultati globali con raggio pari al valore di default 2 \newline(\textbf{KITTY DATASET - 07}) [laptop] }
    \begin{tabular}{lcccccc}
        \toprule
        \rowcolor{gray!20}
        Device & \cellcolor{blue!20}GPU & \cellcolor{orange!20}CPU  \\
