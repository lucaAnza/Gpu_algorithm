...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{img/GPU_opt1_findDistance.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{img/GPU_opt1_findMinDistance.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\textwidth]{img/pyramid.png}}
    \caption{Rappresentazione visiva dell'octave \cite{SLAM-Pyramid}}
\end{figure}
