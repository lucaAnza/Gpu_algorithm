...
Di seguito sono presentati i risultati dell'esperimento, accompagnati da un'analisi comparativa con le prestazioni ottenute dalla corrispondente implementazione su \textbf{CPU}.
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\textwidth]{img/time_comparison1_kitti06.png}}
