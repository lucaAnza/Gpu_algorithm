...
\subsection{Parallelizazione della "ricerca delle distanze minime" }
...
\begin{figure}[h]
    ...
    \caption{Analisi dei compiti dei singoli thread (calcolo distanza) }
\end{figure}

\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=0.6\textwidth]{img/GPU_opt1_findMinDistance.png}}
    \caption{Analisi dei compiti dei singoli thread (calcolo distanza minima) }
\end{figure}
...
\subsection{Parallelizazione del "filtraggio sulle distanze" }
